...
public class project extends JFrame implements ActionListener{
    ...
    project(String atype, String meter) {
        this.atype = atype;
        this.meter = meter; 
        setExtendedState(JFrame.MAXIMIZED_BOTH);// length and width would be maximize
        
        ImageIcon i1 = new ImageIcon(ClassLoader.getSystemResource("icon/window.jpg"));
        ...
        ImageIcon icon7 = new ImageIcon(ClassLoader.getSystemResource("icon/icon12.png"));
        ...
        ImageIcon icon10 = new ImageIcon(ClassLoader.getSystemResource("icon/icon13.png"));
